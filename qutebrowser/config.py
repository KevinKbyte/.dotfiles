...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-[>': '<Escape>', '<Enter>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-J>': '<Return>', '<Shift-Return>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-M>': '<Return>'}
...
## Type: Dict
# c.content.javascript.log = {'warning': 'debug', 'error': 'debug', 'info': 'debug', 'unknown': 'debug'}
...
## Type: Padding
# c.statusbar.padding = {'top': 1, 'bottom': 1, 'right': 0, 'left': 0}
...
## Type: Padding
# c.tabs.indicator.padding = {'top': 2, 'bottom': 2, 'right': 4, 'left': 0}
...
## Type: Padding
# c.tabs.padding = {'top': 0, 'bottom': 0, 'right': 5, 'left': 5}
