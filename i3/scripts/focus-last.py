#!/usr/bin/env python3
# https://www.reddit.com/r/i3wm/comments/3o2bdn/i3_how_to_quickly_switch_between_current_and/
# https://github.com/acrisci/i3ipc-python/blob/master/examples/focus-last.py#L69
